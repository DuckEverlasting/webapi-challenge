...
- [x] Mention two parts of Express that you learned about this week.
        Express has options to use (and create) middleware, and also allows for routing.

- [X] Describe Middleware?
        Middleware is... exactly what it sounds like. It is code activated in the middle of a process, interpreting the data and performing whatever tasks are laid out for it before sending the (possibly modified) data back on it's original path (unless it chooses to end the process. Middleware is flexible.)

- [x] Describe a Resource?
        A resource is an object that contains data, with methods to get, put, post, and delete that data.

- [x] What can the API return to help clients know if a request was successful?
        An HTML status code!!!!!!!!! (Specifically, one of the codes between 200-299)

- [x] How can we partition our application into sub-applications?
        Routers are a pretty good way to go here. Similar to how we break things down to components in React (and in vanilla JS, for that matter).
